...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState('beijing-2026');
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'beijing-2026' ? (
            ...
            >
                ...
                <div className="space-y-8 text-lg leading-relaxed text-zinc-800">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                    <div className="p-10 bg-zinc-900 rounded-[2.5rem] text-white relative overflow-hidden group">
                      ...
                      <div className="relative z-10">
                        <h3 className="text-3xl font-black mb-4 leading-tight">活动信息</h3>
                        <div className="space-y-2 text-zinc-400 text-sm mb-8">
                          <p>📍 地点：硅谷 Sunnyvale</p>
                          <p>📅 日期：3 月 19 日（周四）</p>
                          <p>⏰ 时间：9:30 AM - 17:00 PM (PDT)</p>
                        </div>
                        <button 
                          onClick={() => setShowContactModal(true)}
                          className="flex items-center gap-3 text-xs font-bold uppercase tracking-widest bg-white text-zinc-900 px-6 py-3 rounded-full hover:bg-zinc-200 transition-all"
                    ...
                    <div className="p-10 bg-white border border-zinc-200 rounded-[2.5rem] relative overflow-hidden group">
                      ...
                      <div className="relative z-10">
                        <h3 className="text-3xl font-black mb-6 leading-tight text-zinc-900">💡 核心金句</h3>
                        <div className="space-y-6">
                          <div className="border-l-2 border-zinc-900 pl-4">
                            <p className="text-sm italic text-zinc-600 mb-2">“当 AI 进入物理世界，能看能听以后，它带来的价值远远超出了我们今天的预期。它能主动想在你前面、帮在你前面，这是 Proactive AI 的大趋势。”</p>
                            <p className="text-xs font-bold text-zinc-900">— Kara 李欣航</p>
                          </div>
                          <div className="border-l-2 border-zinc-900 pl-4">
                            <p className="text-sm italic text-zinc-600 mb-2">“我们尽量减少在工程化里强行进行‘信息压缩’的人为干预，让模型具备更强的能力去处理海量数据，语言、视觉和其他感官的结合，会让记忆的方式越来越自然。”</p>
                            <p className="text-xs font-bold text-zinc-900">— Troy Hua</p>
                          </div>
                          <div className="border-l-2 border-zinc-900 pl-4">
                            <p className="text-sm italic text-zinc-600 mb-2">“今天的时代红利极大，在北美，很多人并不在意你是不是采用了最 Cutting-edge（前沿）的技术，只要你把 PLG（产品驱动增长）做好，把产品实实在在地铺到用户面前解决特定需求，就能卖得很好。”</p>
                            <p className="text-xs font-bold text-zinc-900">— William Gao</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              {/* Round Table */}
              <section className="mb-40">
                <SectionHeader number="02" title="圆桌讨论" subtitle="Round Table" />
                ...
                <div className="space-y-32">
                  <RoundTableTopic title="一、 开场与嘉宾背景：Why are we here？" icon={Users}>
                    <div className="space-y-8 text-zinc-700 leading-relaxed text-lg">
                      <div className="pl-6 border-l-4 border-zinc-200">
                        ...
                        <p>我们是一家产业资本，专注于 AI 软硬一体的产品及前沿技术带来的新体验。像我现在佩戴的这款产品叫 Uki，它是一个多模态的 AI 智能硬件，给 AI 长了眼睛和耳朵。我们主要在早期为创业者提供资金与供应链支持。</p>
                      </div>
                      <div className="pl-6 border-l-4 border-zinc-200">
                  ...
                  <RoundTableTopic title="二、 核心探讨：什么是真正的主动式（Proactive）AI？" icon={Zap}>
                    <div className="space-y-10">
                      <p className="text-zinc-500 italic text-xl">“你的设备到底仅仅是 Always on（一直在线），还是可以做到 Proactive（主动式）？”</p>
                      <div className="grid grid-cols-1 gap-8">
                        <QuoteBlock 
                          author="William Gao"
                          text="如何进一步让它把 Output 变成一个长时间、相对复杂的 Agent Action？这是业界正在转变的方向，也是我们在做的事情。"
                        />
                        <QuoteBlock 
                          author="Troy Hua"
                          text="主动触发的‘内容’质量，完全取决于 AI 能够获取并处理多长的 Context。我设想过一个场景：智能桌搭主动对主人说：‘我今天在窗外看到一只鸟，我用你喜欢的水墨画风格把它画了下来。’"
                        />
                        <QuoteBlock 
                          author="Kara 李欣航"
                          text="当 AI 进入物理世界，能看能听以后，它带来的价值远远超出了我们今天的预期。它能主动想在你前面、帮在你前面，这是 Proactive AI 的大趋势。"
                        />
                      </div>
                    </div>
                  </RoundTableTopic>
                    ...
                    <div className="p-10 bg-zinc-900 text-white rounded-[3rem] relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-zinc-400 leading-relaxed">
                          当下确实有很多完美形态还做不到，但这会随着底座能力的提升逐渐被解决。创业者需要找到那个“甜点位”，在现有技术限制下提供最大的用户价值。
                        </p>
                      </div>
                    </div>
                  </RoundTableTopic>
                    ...
                    <div className="space-y-10">
                      ...
                      <div className="p-10 border border-zinc-200 rounded-[2.5rem] bg-zinc-50 relative overflow-hidden">
                        ...
                        <p className="text-lg text-zinc-600 leading-relaxed relative z-10">
                          我们提出了 <span className="font-bold text-zinc-900">Memory Spark Potential Model</span> 架构，支持一亿 Token 的上下文操作，天然支持多模态数据，不需要转译成文本，在没有任何信息损失的情况下直接进入 AI。
                        </p>
                      </div>
                    </div>
                  </RoundTableTopic>
                  ...
                  <RoundTableTopic title="五、 路线选择：为什么坚持做基于音频（Audio）的 AI 硬件？" icon={Mic}>
                    <div className="space-y-8">
                      <QuoteBlock 
                        author="William Gao"
                        text="核心痛点就是能耗。如果使用 Camera Module，耗电极高。为了做得很轻，我们最初选择了 Audio 赛道。Audio 消耗的能耗很低，但能做的事情极多，比如自动在办公系统里帮你发送文件。"
                      />
                  ...
                  <RoundTableTopic title="六、 出海与生态：全球化背景下的创业机遇与破圈建议" icon={Globe}>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                      <div className="p-10 border border-zinc-200 rounded-[2.5rem] hover:border-zinc-900 transition-colors group">
                        ...
                        <p className="text-zinc-600 leading-relaxed">
                          北美是极好的市场，用户付费意愿强。一定要 <span className="font-bold text-zinc-900">Leverage 中国的供应链优势</span>，这能大幅提升初创公司早期的速度。
                        </p>
                      </div>
                      <div className="p-10 border border-zinc-200 rounded-[2.5rem] hover:border-zinc-900 transition-colors group">
                        <h5 className="font-black text-2xl text-zinc-900 mb-6 group-hover:translate-x-2 transition-transform">Troy 的建议</h5>
                        <p className="text-zinc-600 leading-relaxed">
                          我更看好开源的 <span className="font-bold text-zinc-900">Local 模型</span>，因为隐私和响应速度对硬件来说至关重要。创业者应该多关注如何让模型在端侧跑得更稳。
                        </p>
                      </div>
                      <div className="p-10 border border-zinc-200 rounded-[2.5rem] hover:border-zinc-900 transition-colors group">
                        <h5 className="font-black text-2xl text-zinc-900 mb-6 group-hover:translate-x-2 transition-transform">William 的建议</h5>
                        <p className="text-zinc-600 leading-relaxed">
                          今天的时代红利极大，在北美，很多人并不在意你是否采用最前沿的技术，只要你把 <span className="font-bold text-zinc-900">PLG（产品驱动增长）</span> 做好，实实在在地解决特定需求，就能卖得很好。
                        </p>
                      </div>
                    </div>
              ...
              {/* Coming Soon */}
              <section className="mb-40">
                <div className="text-center py-20 bg-zinc-900 text-white rounded-[3rem] relative overflow-hidden">
                  ...
                  <Sparkles className="mx-auto text-zinc-500 mb-6 relative z-10" size={48} />
                  <h3 className="text-2xl font-bold mb-4 relative z-10">嘉宾分享 & Lightning Demo</h3>
                  <p className="text-zinc-400 max-w-md mx-auto leading-relaxed relative z-10">
                    后续精彩内容正在快马加鞭处理中，敬请期待。
                  </p>
                </div>
              </section>
            </motion.div>
