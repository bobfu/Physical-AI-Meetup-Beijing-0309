                  ...
                  <FullSpeakerSection 
                    ...
                    content={[
                      ...
                      },
                      {
                        ...
                        body: "最新的 R2 全场景 AI 机器人开发套件 在继承极致语音交互能力的基础上，引入了视频流大模型视觉理解，使 AI 能理解动态过程而不仅是静态图片。同时，通过支持 多自由度运动控制，赋予设备丰富的「肢体语言」（例如，AI 在认错时会「低头」致歉），极大地增强了桌面机器人、陪伴类产品的情感连接与拟人化体验，推动 AI 硬件从「开口说话」向「能看会动」的情感智能体演进。"
                      }
                    ]}
                  />
                </div>
